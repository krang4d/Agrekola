...
private:
    ...
    double m_dataSeriesD[sampleSize];	// The values for the data series D
    ...
    QLabel *m_ValueD;                   // Label to display the realtime value D
...
private slots:
    ...
    void getData(std::list<double> *dataList);    // Get new data values
