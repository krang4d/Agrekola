...
std::string LoadE154::OpenDevice()
{
    ...
    if(i == MaxVirtualSoltsQuantity) throw Errore_E154("Ошибка подключения модуля E154!\n"); //AbortProgram(" Can't find any module E-154 in first 127 virtual slots!\n");
...
std::string LoadE154::GetInformation()
{
    ...
    char *serialNum;
//    serialNum = static_cast<char *>(ModuleDescription.Module.SerialNumber[0]);
//    str += "Module E-154 (S/N" + serialNum + ") is ready ... \n";
